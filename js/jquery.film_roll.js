...
(function ($) {
  this.FilmRoll = (function () {
    ...
    FilmRoll.prototype.configure = function () {
      ...
      this.pager_links = this.div.find(".film_roll_pager button");
          ...
          swipeStatus: (function (_this) {
            return function (event, phase, direction, distance) {
              ...
              if (phase === "start") {
                ...
                if (
                  wrapper_width >= _this.real_width ||
                  _this.children.length === 1
                ) {
                  return false;
                }
                ...
                rotation_index = $.inArray(
                  _this.children[_this.index],
                  _this.rotation
                );
                _this.offscreen_left = parseInt(_this.shuttle.css("left"), 10);
                _this.offscreen_right =
                  _this.marginRight(rotation_index) -
                  (wrapper_width - _this.child_widths[_this.index]) / 2;
                ...
                if (direction === "left") {
                  ...
                  if (distance > _this.offscreen_right) {
                    ...
                    _this.offscreen_right += _this.childWidth(
                      _this.rotation[_this.rotation.length - 1]
                    );
                  }
    ...
    FilmRoll.prototype.configureWidths = function () {
      ...
      if (this.options.height) {
        ...
        this.wrapper.css(
          "min-height",
          min_height + this.options.height_padding
        );
      }
      this.real_width = this.width;
      this.shuttle
        .width(this.real_width * 2)
    ...
    FilmRoll.prototype.moveToIndex = function (index, direction, animate) {
      ...
      if (this.options.position === "left") {
        ...
        visible_margin_left =
          wrapper_width - this.child_widths[index] + this.offset;
      } else {
        visible_margin_left = remainder / 2 + this.offset;
      }
      visible_margin_right = remainder - visible_margin_left;
      if (
        (wrapper_width < this.real_width && this.children.length > 1) ||
        this.options.force_rotate
      ) {
        if (direction === "right") {
          while (
            rotation_index === 0 ||
            this.marginLeft(rotation_index) < visible_margin_left
          ) {
            this.rotateRight();
            rotation_index = $.inArray(child, this.rotation);
          }
          ...
          while (
            rotation_index === this.children.length - 1 ||
            this.marginRight(rotation_index) < visible_margin_right
          ) {
            this.rotateLeft();
            rotation_index = $.inArray(child, this.rotation);
          }
      ...
      new_left_margin =
        -1 * (this.marginLeft(rotation_index) - visible_margin_left);
      if (animate) {
